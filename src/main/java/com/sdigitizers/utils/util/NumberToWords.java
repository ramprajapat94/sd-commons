 ...
 */
 public final class NumberToWords {
        ...
        public static String convertNumberToWords(BigDecimal parameter) {
            ...
            if (quotient > 0) {
                word.append(numberToWords(quotient)).append(" Lakh ");
            }
            number = number % 100000;

            quotient = (int) (number / 1000);
            if (quotient > 0) {
                word.append(numberToWords(quotient)).append(" Thousand ");
            }
            ...
            if (quotient > 0) {
                word.append(numberToWords(quotient)).append(" Hundred ");
            }

            number = number % 100;
            if (number != 0) {
                word.append(numberToWords((int) number)).append(" ");
            }
